...
public class CrazyCatLady {
	public static void main(String[] args) {
		...
		String epic = JOptionPane.showInputDialog(null, "how much cat?");
		// 2. Convert their answer into an int
		int c = Integer.parseInt(epic);
		// 3. If they have 3 or more cats, tell them they are a crazy cat lady
		if (c >= 3) {
			JOptionPane.showMessageDialog(null, "u crazy cat lady");
		}
		// 4. If they have less than 3 cats AND more than 0 cats, call the method below
		// to show them a cat video
		else if (c > 0 && c < 3) {
			playVideo("https://www.youtube.com/watch?v=iWFmHq8wnOk");
